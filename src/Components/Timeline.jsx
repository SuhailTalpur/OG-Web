export default function Timeline() {
    ...
    return (
      <section className="py-16 px-6 md:px-16 lg:px-24">
        <h2 className="righteous text-5xl md:text-5xl font-extrabold text-center mb-12">
          Orangutan Roadmap
        </h2>
        <div className="relative border-l-4 border-orange-500 mx-auto max-w-4xl">
          {timelineData.map((item, index) => (
            <div key={index} className="mb-10 ml-6 flex items-start relative">
              ...
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg w-full md:w-4/5">
                <p className="text-sm text-orange-500 font-semibold">PHASE {index + 1}</p>
