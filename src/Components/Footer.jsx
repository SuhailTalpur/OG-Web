      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        ...
        <div className="flex space-x-6 text-xl">
          <a href="https://x.com/orangutanxlabs" target="_blank" rel="noopener noreferrer">
            <FaTwitter className="text-2xl md:text-2xl cursor-pointer text-text hover:text-orange-400 transition duration-150 ease-in-out" />
          </a>
          <a href="https://discord.gg/vMgAYQZRDW" target="_blank" rel="noopener noreferrer">
            <FaDiscord className="text-2xl md:text-2xl cursor-pointer text-text hover:text-orange-400 transition duration-150 ease-in-out" />
          </a>
        </div>
      </div>

      <div className="border-t border-gray-700 mt-10 pt-4 text-black text-sm">
