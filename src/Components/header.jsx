    ...
    return (
        <header className="">
            ...
            <nav className="flex flex-wrap justify-between items-center py-6 px-6 md:px-12">
                <h1 className="text-3xl md:text-4xl font-semibold righteous text-orange-500">
                    OrangutanX
                </h1>
                <div className="flex space-x-4">
                    <a href="https://x.com/orangutanxlabs" target="_blank" rel="noopener noreferrer">
                        <FaTwitter className="text-2xl md:text-3xl cursor-pointer text-orange-500 hover:text-orange-400 transition duration-150 ease-in-out" />
                    </a>
                    <a href="https://discord.gg/vMgAYQZRDW" target="_blank" rel="noopener noreferrer">
                        <FaDiscord className="text-2xl md:text-3xl cursor-pointer text-orange-500 hover:text-orange-400 transition duration-150 ease-in-out" />
                    </a>
                </div>
            ...
            <div className="flex flex-col lg:flex-row justify-around items-center min-h-[80vh] px-6 md:px-12">
                ...
                <div className="text-center lg:text-left space-y-6 max-w-lg">
                    <h1 className="text-4xl md:text-6xl font-bold text-orange-500 righteous">
                        OrangutanX
                    </h1>
                ...
                <div className="flex space-x-2 mt-6 lg:mt-0">
                    <img src={img} alt="NFT 1" className="w-32 md:w-48 lg:w-64 rounded-2xl" />
                    <img src={img2} alt="NFT 2" className="w-32 md:w-48 lg:w-64 rounded-2xl" />
                </div>
            </div>
        </header>
    );
